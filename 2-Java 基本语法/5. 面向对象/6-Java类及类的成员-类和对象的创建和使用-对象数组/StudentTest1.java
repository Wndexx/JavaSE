...
public class StudentTest1 {
	public static void main(String[] args) {
		...
		for(int i = 0;i < stus.length;i++) {
			...
			stus[i].number = i + 1;
			// 年级 [1,6]
			stus[i].state = (int) Math.round(Math.random() * 6 + 1);
			// 成绩 [0,100]
			stus[i].score = (int) Math.round(Math.random() * 101);
		}
	...
	/**
	 *  
	 * @Description 遍历 Student1[] 数组的操作
	 * @author wndexx
	 * @date 2022年2月5日下午5:38:09
	 * @param stus
	 *
	 */
