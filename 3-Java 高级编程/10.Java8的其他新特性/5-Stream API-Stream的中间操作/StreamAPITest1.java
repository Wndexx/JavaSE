...
public class StreamAPITest1 {
    ...
    */
    ...
    public void test1() {
        ...
        // 3. skip(long n)：跳过元素，返回一个扔掉了前 n 个元素的流。若流中元素不足 n 个，则返回一 个空流。与 limit(n) 互补
    ...
    */
    ...
    public void test2() {
        ...
        // 1. map(Function f)：接收一个函数作为参数，将元素转换成其他他形式或提取信息，该函数会被应用到每一个元素上，并将其映射成一个新的元素
        ...
        // employees.stream().filter(e -> e.getName().length() > 3).map(Employee::getName).forEach(System.out::println);
    ...
    */
    ...
    public void test4() {
        ...
        // 2. sorted(Comparator com)：产生一个新流，定制排序
        List<Employee> employees = EmployeeData.getEmployees();
