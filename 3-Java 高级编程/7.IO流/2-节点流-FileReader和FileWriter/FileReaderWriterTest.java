...
/*
    ...
    二、流的体系结构：
        ...
        Reader                  FileReader(read(char[] cbuf))                   BufferedReader(read(char[] cbuf) / readLine(String date))
...
public class FileReaderWriterTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(file.getAbsolutePath()); // E:\project\IdeaProjects\workspace_idea\JavaSenior\hello.txt

        File file1 = new File("day09\\hello.txt");
        System.out.println(file1.getAbsolutePath()); // E:\project\IdeaProjects\workspace_idea\JavaSenior\day09\hello.txt
    }

    /*
        将 day09 下的 hello.txt 文件内容读入程序中，并输出到控制台

        说明点：

            1. read() 的理解：返回读入的一个字符。如果达到文件末尾，返回 -1

            2. 异常的处理：为了保证流资源一定可以执行关闭操作，需要使用 try-catch-finally 来处理

            3. 读入的文件一定存在，否则就会报 FileNotFoundException
    */
    @Test
    ...
    */
    ...
    public void testFileReaderFileWriter() {
        ...
        try {
            ...
            // File destFile = new File("ranni.jpg");
