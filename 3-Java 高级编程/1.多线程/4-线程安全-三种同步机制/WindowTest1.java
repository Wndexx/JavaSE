...
/*
    ...
    1. 问题：买票过程中，出现了重票和错票 ---> 出现了线程的安全问题

    2. 问题出现的原因：当某个线程操作车票的过程中，尚未操作完成时，其他线程参与进来，也操作车票

    3. 如何解决：当一个线程a 在操作 ticket 的时候，其他线程不能参与进来，直到线程a 操作完 ticket 的时候，其他线程才可以开始操作 ticket。

       这种情况即使线程a 出现了阻塞，也不能被改变。
    ...
    4. 在 Java 中，我们通过同步机制，来解决线程的安全问题
        ...
        方式二：同步方法
            ...
            如果操作共享数据的代码完整的声明在一个方法中，我们不妨将此方法声明为同步的 synchronized
			...
			关于同步方法的总结：
				...
				2. 非静态的同步方法，同步监视器是：this
				   ...
				   静态的同步方法，同步监视器是：当前类本身 (与该同步方法是否用类调用还是对象调用无关)
