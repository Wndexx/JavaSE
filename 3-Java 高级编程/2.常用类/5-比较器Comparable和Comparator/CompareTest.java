...
/**
 * @author wndexx
 * @create 2022-02-26 18:24
 */

/*
    一、说明：Java 中的对象，正常情况下，只能进行比较操作：== 或 !=，不能使用 > 或 < 的

        但是在开发的场景中，需要对多个对象进行排序，言外之意，就需要比较对象的大小

        如何实现？使用两个接口中的任何一个：Comparable 或 Comparator

    二、Comparable 接口 与 Comparator 的使用的对比：

        Comparable 接口的方式一旦指定，保证 Comparable 接口实现类的对象都可以比较大小
...
public class CompareTest {
    ...
    /*
        ...
        1. 像 String 、包装类 等实现了 Comparable 接口，重写了 compareTo(obj) 方法，给出了比较两个对象大小的方式

        2. 像 String 、包装类重写 compareTo() 方法以后，进行了从写到大的排列
